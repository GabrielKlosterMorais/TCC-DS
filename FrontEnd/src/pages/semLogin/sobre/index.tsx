      ...
      <main>
        ...
        <section className="numbers-section">
          ...
          <div className="numbers-content">
            <span className="section-label">PETCARE EM NÚMEROS</span>
        ...
        <section className="about-cta">
          <div>
            <span>FAÇA PARTE DO PETCARE</span>

            <h2>Cuide melhor de quem faz parte da sua família.</h2>

            <p>Crie sua conta e comece a organizar os cuidados do seu pet.</p>
          </div>

          <a href="/registro" className="cta-button">
            <span className="cta-text">Criar minha conta</span>
